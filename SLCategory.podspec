...
Pod::Spec.new do |s|
  s.name             = 'SLCategory'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SLCategory.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/forestfsl/SLCategory'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'forestfsl' => 'fengsonglin@beiyugame.com' }
  s.source           = { :git => 'https://github.com/forestfsl/SLCategory.git', :tag => s.version.to_s }
